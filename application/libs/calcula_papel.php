...
function calculaPapel($papel_ancho, $papel_largo, $corte_ancho, $corte_largo, $parte, $textura, $precio, $papel, $data_name, $data_laminado, $id_papel, $data_offset, $data_digital) {
    ...
    if(validarForma() === 1){
        ...
        $b      = Math.max($papel_ancho, $papel_largo);
        $h      = Math.min($papel_ancho, $papel_largo);
        $cb     = $c_ancho;
        $ch     = $c_largo;
        $escala = 250 / $b;
...
//        $cortes_H      = acomoda($b, $h, $c_ancho, $c_largo, "N", "H");
        ...
        console.log('(3432) totalCortes: ' + totalCortes + ' totalCortes_H: ' + totalCortes_H);
...
//            cortesH2 = cortes_H.cortesT;
        ...
        console.log('(3500) totalCortes: ' + totalCortes + ' totalCortes_H: ' + totalCortes_H);
/*
        calcular_area_V = calcularArea(b, h, cb, ch, totalCortes);
        calcular_area_H = calcularArea(b, h, cb, ch, totalCortes_H);

*/
        console.log('(3506) totalCortes: ' + totalCortes + ' totalCortes_H: ' + totalCortes_H);
...
//        H_cortes = calcular(b, h, cortesV2, cortesH2, totalCortes_H, cortes_H.cortesT, cortes_deseados, "H");
        ...
        console.log('(3519) V_cortes: ' + V_cortes + '; H_cortes: ' + H_cortes);
        ...
        console.log('(3545)---------');
        console.log('(3546) orientacion: ' + orientacion);
        console.log('(3547) cortes_final: ' + cortes_final.toFixed(0));
        console.log('(3548) costo: ' + costo.toFixed(2));
...
*/
        ...
        console.log('(3718) aTr3_tmp: ' + aTr3_tmp);
        console.log('(3719) costo_papel_tmp: ' + costo_papel_tmp);
        console.log('(3720) aCortes: ' + acortes_tmp);
        console.log('(3721) data_offset: ' + data_offset+ '; data_digital: ' + data_digital + ' data_laminado: ' + data_laminado);
        ...
        console.log('(3730) num_rows: ' + num_rows);
...
//                document.getElementById("table-general").deleteRow(0);
        ...
        console.log('(3741) num_rows: ' + num_rows);
...
//            jQuery214('#table-general').append(tr1);
    ...
    console.log('(3762) aTr3_tmp: ' + aTr3_tmp);
