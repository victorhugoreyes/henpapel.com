...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <span class="tit_cajasedit">Cerillera</span>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="table-responsive">
                ...
                <form name="form2" id="form2" method="POST" action="<?php echo URL; ?>cajas/updateCajas">
                    ...
                    <input type="hidden" name="modelo" value="6">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Profundidad Tapa:</td>
                            <td>
                            
                                <input class="form_cajas" type="number" step="any" placeholder="cm" name="profundidad-tapa" value="<?php echo $profundidad_tapa; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Grosor Cajón:</td>
