...
$profundidad_tapa  = $rows_almeja['profundidad-tapa'];
$grosor_cajon      = $rows_almeja['grosor-cajon'];
$grosor_tapa       = $rows_almeja['grosor-tapa'];
...
print "<br />42. fecha_hoy: " . $fecha_hoy;
...
print "<br />profundidad_tapa: " . $profundidad_tapa;
print "<br />grosor_cajon: " . $grosor_cajon;
print "<br />grosor_tapa: " . $grosor_tapa;
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <span class="tit_cajasedit">Regalo</span>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="table-responsive">
                ...
                <form name="form2" id="form2" method="POST" action="<?php echo URL; ?>cajas/updateCajas">
                    ...
                    <input type="hidden" name="modelo" value="4">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Profundidad del cajón:</td>
                            <td>
                            
                                <input type="number" step="any" placeholder="cm" name="profundidad-cajon" value="<?php echo $profundidad_cajon; ?>" class="form_cajas">
                            </td>
                        </tr>
                        <tr>
                            <td>Profundidad de tapa:</td>
                            <td>
                            
                                <input type="number" step="any" placeholder="cm" name="profundidad-tapa" value="<?php echo $profundidad_tapa; ?>" class="form_cajas">
                            </td>
                        </tr>
                        <tr>
                            <td>Grosor Cajón:</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select class="cajas-input" name="grosor-tapa" value="<?php echo $grosor_tapa; ?>">
                            
                                    <option selected><?php echo $grosor_tapa; ?></option>
                                    <option value="1">1</option>
                                    <option value="1.25">1.25</option>
                                    <option value="1.5">1.5</option>
                                    <option value="2">2</option>
