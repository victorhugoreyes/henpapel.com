...
<div id="content" class="container_12">
    ...
    <div class="resume1">
        <div>Caja Almeja. ODT: <span><?=$odt ?> | </span></div>
        ...
        <div class="gallery">
            ...
            <div class="items">
                ...
                <div class="grid_6">
                    ...
                    <img src="<?= URL; ?>public/images/almeja/01_carton_cajon_Tipo Almeja16.ai.jpg" style="width: 350px; height: 350px" />
                </div>
                    ...
                    <div class="print">
                        <div>
                            <table class="print-tabla">
                                ...
                                <tr class="print-reng">
                                    <td class="print-td text-justify">Base extendida del cajón</td>
                                    <td class="nomenclatura_2">x</td>
                                    <td class="print-td"><?php echo round($x,2) ?> cm</td>
                                </tr>
                                <tr class="print-reng">
                                    <td class="print-td">Altura extendida del cajon</td>
                                    <td class="nomenclatura_2">y</td>
                                    <td class="print-td"><?php echo round($y,2) ?> cm</td>
                                </tr>
                                <tr class="print-reng">
                                    <td class="print-td">Base del cajón para empalme</td>
                                    <td class="nomenclatura_2">x'</td>
        ...
        <div class="gallery">
            ...
            <div class="items">
                ...
                <div class="grid_6">
                    ...
                    <img src="<?= URL; ?>public/images/almeja/02_forro_cajon_Tipo Almeja17.jpg" style="width: 350px; height: 350px" />
                </div>
        ...
        <div class="gallery">
            ...
            <div class="items">
                ...
                <div class="grid_6">
                    ...
                    <img src="<?= URL; ?>public/images/almeja/03_carton_cartera_Tipo Almeja18.jpg" style="width: 350px; height: 350px" />
                </div>
                    ...
                    <div class="print">
                        <div>
                            <table class="print-tabla">
                                ...
                                <tr class="print-reng">
                                    <td class="print-td">Altura Cartera</td>
                                    <td class="nomenclatura_2">H</td>
                                    <td class="print-td"><?php echo round($H, 2); ?> cm</td>
                                </tr>
                                <tr class="print-reng">
                                    <td class="print-td">Profundidad Cartera Lomos</td>
                                    <td class="nomenclatura_2">P</td>
                                    <td class="print-td"><?php echo round($P, 2); ?> cm</td>
                                </tr>
                                <tr class="print-reng">
                                    <td class="print-td">Base Cartera</td>
                                    <td class="nomenclatura_2">B</td>
                                    <td class="print-td"><?php echo round($B, 2); ?> cm</td>
                                </tr>
                                <tr class="print-reng">
                                    <td class="print-td">Altura Total de Cartera</td>
                                    <td class="nomenclatura_2">Y</td>
                                    <td class="print-td"><?php echo round($Y, 2); ?> cm</td>
                                </tr>
                            </table>
        ...
        <div class="gallery">
            ...
            <div class="items">
                ...
                <div class="grid_6">
                    ...
                    <img src="<?= URL; ?>public/images/almeja/04_forro_cartera_Tipo Almeja19.jpg" style="width: 350px; height: 350px" />
                </div>
        ...
        <div class="gallery">
            ...
            <div class="items">
                ...
                <div class="grid_6">
                    ...
                    <img src="<?= URL; ?>public/images/almeja/05_guarda_Tipo Almeja20.jpg" style="width: 350px; height: 350px" />
                </div>
                    ...
                    <div class="print">
                        <div>
                            <table class="print-tabla">
                                <tr>
                                    <td colspan="2" class="print-titulo">
                                        <h2 style="text-align: center;">Guarda Cartera</h2>
                                    </td>
                                </tr>
                                <tr class="print-reng">
                                    <td class="print-td">Base de Guarda Cartera</td>
                                    <td class="nomenclatura_2">B''</td>
                                    <td class="print-td"><?php echo round($B11, 2); ?> cm</td>
                                </tr>
                                <tr class="print-reng">
                                    <td class="print-td">Altura de Guarda Cartera</td>
                                    <td class="nomenclatura_2">Y''</td>
                                    <td class="print-td"><?php echo round($Y11, 2); ?> cm</td>
                                </tr>
                            </table>
