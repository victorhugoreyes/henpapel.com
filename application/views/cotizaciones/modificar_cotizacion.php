    ...
    <div class="login-box2" style="border-color: #999;" >
        ...
        <div class="form-inner">
            ...
            <div  style="margin-top: 10px; border-bottom: dashed 1px black;padding-bottom: 15px; border-top-left-radius: 15px; border-top-right-radius: 15px; display: flex; justify-content: center; align-items: center;" class="azulWhi">
                ...
                <h1 style="text-align:center;color:#fff;margin-top:20px;font-weight:normal;font-size:18px; text-transform: uppercase;">MODIFICAR COTIZACIÓN - <?=$idCot?></h1>
                <br>
            </div>
                        ...
                        <?php
                            foreach ($cotizacion as $row) {?>
                                ...
                                <tr class="detalle">
                                    ...
                                    <td style=" border-right: 1px #999 solid; "><p><?=$row['descripcion']?></p></td>
                                    <td style=" border-right: 1px #999 solid; "><p><?=$row['cantidad']?></p></td>
                                    <td style=" border-right: 1px #999 solid; "><p>$<?=$row['precio']?></p></td>
                                    <td style="display: none;"><p><?=$row['subtotal']?></p></td>
                                    <td style="display: none;"><p><?=$row['iva']?></p></td>
                                    <td style=" border-right: 1px #999 dashed; "><p><?=$row['monto']?></p></td>
                                    <td class="eliminar" style=" display: flex; align-items: center; justify-content: center"><img class="btnEliminar" src="<?= URL ?>public/img/tf.png" style="width: 25px; cursor: pointer" /></td>
                                </tr>
                        <?php
                            }
                        ?>
                ...
                <table id="tblTotal" class="table">
                    ...
                    <tr id="trTotal">
                        ...
                        <td style=" border-left: 1px #999 dashed">
                            ...
                            <p id="lblTotalT">$<?=$cotizacion[0]['monto_total']?></p>
            ...
            <div class="btn-group" role="group" aria-label="Basic example" style="align-items: center; justify-content: center; display: flex; margin: 15px;">
                ...
                <button id="btnEnviar" type="button" class="btn">ACTUALIZAR</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $("#btnEnviar").click( function(){
        ...
        var idT = location.href.split("/");
        idT = idT[6].split("=");
        idT = parseInt(idT[1]);
        $.ajax({

            url: "<?= URL ?>cotizador/updateCotizacion/?idCot="+idT,
            method: "POST",
            data: datos,
