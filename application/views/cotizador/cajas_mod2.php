...
<script>
    ...
    $(document).ready(function() {
        ...
        console.log('jbsjbsbs: ' + <?=$papelfcajon1['id_papel']?>);
    });
</script>
...
<div class="selectormodelo">
    ...
    <div class="div-izquierdo">
        ...
        <select  id="box-model" class="seleccionModelo" style="background: #1A2C4C;color:#fff;font-size: 16px; width: -webkit-fill-available; border: none; height: 35px">
            ...
            <option style="font-size: 1em" value="<?=$tipoC?>"><?=$TipoModelo;?></option>
...
<div id="form_modelo_1">
    ...
    <form class="caja-form" name="caja-form" id="caja-form" method="post" action="<?php echo URL; ?>cotizador/saveCaja/">
        ...
        <div class="wrap cont-grid" id="form_modelo_2_grid">
                ...
                <div class="form-content medidas" style="height: 450px;">
                    ...
                    <div class="input-group">
                        ...
                        <div class="cajas-col-input t-right">
                            ...
                            <input class="cajas-input medidas-input" name="odt" id="odt-1" type="text" disabled value="<?= $cotizacion['id_odt'];?>">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="cajas-col-input t-right">
                            ...
                            -->
                            <input class="cajas-input medidas-input" name="base" id="corte_largo" type="number" step="any" min="0.1" tabindex="2" placeholder="cm" value="<?= $cotizacion['base'];?>" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="cajas-col-input t-right">
                            ...
                            <input class="cajas-input medidas-input not-empty" name="alto" id="corte_ancho" type="number" step="any" min="0.1" tabindex="3" placeholder="cm" value="<?= $cotizacion['alto'];?>" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="cajas-col-input t-right">
                            ...
                            <input class="cajas-input medidas-input" name="profundidad" id="profundidad_1" type="number" step="any" min="0.1" placeholder="cm" tabindex="4" value="<?= $cotizacion['profundidad'];?>" required="">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="cajas-col-input t-right">
                            ...
                            <input class="cajas-input" name="qty" id="qty" type="number" min="1" step="1" placeholder="Cantidad" tabindex="7" value="<?= $cotizacion['cantidad'];?>" required>
                        </div>
                    </div>
                </div>
            ...
            <div id="social" class="social" style="/*width: 45%;*/ float: right; /*display: none;*/">
                ...
                <button type="submit" class="btn btn-success" style="font-size: 10px;">GUARDAR</button>
