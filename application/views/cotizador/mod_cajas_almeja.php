        ...
        <form class="caja-form" name="caja-form" id="caja-form" method="post" action="<?php echo URL; ?>cotizador/saveCaja/">
            ...
            <div class="wrap cont-grid" id="form_modelo_1_grid">
                ...
                <div id="social" class="social" style="/*width: 45%;*/ float: right; /*display: none;*/">
                    ...
                    <button id="subForm" type="button" class="btn btn-success" style="font-size: 10px;" enabled="" data-toggle="modal" data-target="#modalSaveAll">ACTUALIZAR</button>
            ...
            .done(function(response) {
                ...
                if ( response ) {
                    ...
                    try {
                        ...
                        console.log("(3332) " + response.response);
                    ...
                    $("#txtContenido").html("Ya existe esta ODT");
                }
