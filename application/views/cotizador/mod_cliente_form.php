                ...
                <table class="table" style=" border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <label>Nombre
                            <input id="txtNombre" name="txtNombre" type="text" placeholder="Nombre" class="login-input" required="" value="<?= $datos[0]['nombre']?>" /></label>
                        </th>
                        <th>
                            
                            <label>Telefono
                            <input id="txtTelefono" name="txtTelefono" type="text" placeholder="Telefono" class="login-input" value="<?= $datos[0]['telefono'] ?>" /></label>
                        </th>

                        <th>
                            
                            <label>email
                            <input id="txtEmail" name="txtEmail" type="text" placeholder="Email" class="login-input" value="<?= $datos[0]['email'] ?>" /></label>
                        </th>
                    </tr>
                </table>
            </div>
                ...
                <table class="table" style=" border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    ...
                    <tr>
                        ...
                        <th colspan="2">
                            ...
                            <label>Razon Social
                            <input id="txtRS" name="txtRS" type="text" placeholder="Razon Social" class="login-input" required="" value="<?= $datos[0]['razon_social'] ?>" /></label>
                        </th>
                        <th>
                            
                            <label>RFC
                            <input id="txtRFC" onkeydown ="checkLength();" name="txtRFC" type="text" placeholder="RFC" class="login-input" value="<?= $datos[0]['rfc'] ?>" /></label>
                        </th>
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <label>Calle
                            <input id="txtCalle" name="txtCalle" type="text" placeholder="Calle" class="login-input" value="<?= $datos[0]['calle'] ?>" /></label>
                        </th>
                        <th>
                            
                            <label>Colonia
                            <input id="txtColonia" name="txtColonia" type="text" placeholder="Colonia" class="login-input" value="<?= $datos[0]['colonia'] ?>" /></label>
                        </th>
                        <th>
                            
                            <label>N° Exterior
                            <input id="txtNExterior" name="txtNExterior" type="text" placeholder="N° Exterior" class="login-input text-md" value="<?= $datos[0]['no_ext'] ?>" /></label>
                        </th>
                        <th>
                            
                            <label>N° Interior
                            <input id="txtNInterior" name="txtNInterior" type="text" placeholder="N° Interior" class="login-input text-md" value="<?= $datos[0]['no_int'] ?>" /></label>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            ...
                            <label>Codigo Postal
                            <input id="txtCP" name="txtCP" type="text" placeholder="Codigo Postal" class="login-input" value="<?= $datos[0]['cp'] ?>" /></label>
                        </th>
                        <th>
                            
                            <label>Estado
                            <input id="txtEstado" name="txtEstado" type="text" placeholder="Estado" class="login-input" value="<?= $datos[0]['estado'] ?>"/></label>
                        </th>
                        <th>
                            
                            <label>Delegacion
                            <input id="txtDelegacion" name="txtDelegacion" type="text" placeholder="Delegacion" class="login-input" value="<?= $datos[0]['delegacion'] ?>"/></label>
                        </th>
                        
                    </tr>
                </table>
            </div> 
            <button type="submit" id="btnEnviar" name="btnEnviar" class="login-input envio" style="margin-bottom: 10px; text-align: center;">ACTUALIZAR</button>
        </div>
    </div>
</div> 
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label id="lblCliente" style="color: black; font-size: 1.1em">Se Actualizó exitosamente el cliente: </label>
                <br>
...
<script>
    ...
    $("#btnEnviar").click( function (){
        ...
        datos.push({name: "idCliente", value: id});
        ...
        $.ajax({
            ...
            type:"POST",
            url: "<?= URL?>cotizador/updateCliente",   
            data: datos, 
            //dataType:"json",  
            ...
            success:function(response) { 
                ...
                try{
                    ...
                    if( response == true ){
                        ...
                        ocultarLoad();
                        mostrarError("Hubo un Error al actualizar el cliente.");
                    }
                }catch(e){
