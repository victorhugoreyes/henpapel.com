    ...
    <div class="login-box2" style="border-color: #999;" >
        ...
        <div class="form-inner">
            ...
            <div  style="margin-top: 10px; border-bottom: dashed 1px black;padding-bottom: 15px; border-top-left-radius: 15px; border-top-right-radius: 15px; display: flex; justify-content: center; align-items: center;" class="azulWhi">
                ...
                <h1 style="text-align:center;color:#fff;margin-top:20px;font-weight:normal;font-size:18px; text-transform: uppercase;">NUEVA FACTURA - <?= utf8_encode($nombreCliente)?></h1>
                <br>
            </div>
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>
                            ...
                            <label style="margin: 0px;">USO CFDI</label>
                        </td>
                        <td>
                            
                            <label style="margin: 0px;">FORMA DE PAGO</label>
                        </td>
                        <td>
                            
                            <label style="margin: 0px;">METÓDO DE PAGO</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="optCFDI">
                                ...
                                <option id="0" selected="" value="" disabled>Elige</option>
                                <?php foreach ($cfdi as $row){ ?>
                                    
                                    <option id="<?= $row['id_cfdi']?>" value="<?= $row['id_cfdi']?>"><?=$row['clave']?> - <?=$row['descripcion']?></option>
                                <?php
                                    }
                                ?>
                        ...
                        <td>
                            ...
                            <select id="optFPago">
                                ...
                                <?php foreach ($formaPago as $row){ ?>
                                    ...
                                    <option id="<?= $row['id_formapago'] ?>" value="<?= $row['id_formapago']?>" ><?=$row['clave']?> - <?=$row['descripcion']?></option>
                                <?php
                                    }
                                ?>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="optMPago">
                                ...
                                <option id="txtMetPago" name="txtMetPago" selected="" value="" disabled>Elige</option>
                                <?php foreach ($metodoPago as $row){ ?>
                                    
                                    <option id="<?= $row['id_metodopago'] ?>" value="<?= $row['id_metodopago'] ?>"><?=$row['clave']?> - <?=$row['descripcion']?></option>
                                <?php
                                    }
                                ?>
                            </select>
                    ...
                    <tr>
                        <td>
                            ...
                            <label style="margin: 0px;">ORDEN DE LA COMPRA</label>
                        </td>
                        <td>
                            
                            <label style="margin: 0px">ANTICIPO:</label>
                        </td>
                        <td>
                            
                            <label style="margin: 0px;">CLAVE DEL EVENTO</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input style="margin: 0px;" id="txtOCompra" name="txtOCompra" type="text" placeholder="" class="login-input"  style="" />
                            <p>(Si esta definido)</p>
                        </td>
                        ...
                        <td>
                            ...
                            <input style="margin: 0px; " id="txtAnticipo" name="txtAnticipo" type="text" placeholder="" onkeypress="return soloNumeros(event);" onkeyup="insertar0('txtAnticipo');" class="login-input" style="" />
                            <p>(Si esta definido)</p>
                        </td>
                        ...
                        <td>
                            ...
                            <input style="margin: 0px;" id="txtEvento" name="txtEvento" type="text" placeholder="" class="login-input"  style="" />
                            <p>(Si esta definido)</p>
                        </td>
                    </tr>
            ...
            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body" style="overflow: auto;">
                            <table class="" id="tblDetalle" style="display: block;">
            ...
            <div class="btn-group" role="group" aria-label="Basic example" style="align-items: center; justify-content: center; display: flex; margin: 15px;">
                ...
                <button id="accordion" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" type="button" class="btn btn-secondary">DETALLES</button>
                <button id="btnEnviar" type="button" class="btn">GUARDAR</button>
            </div>
            
            <!--<div  style="margin: 0px; margin-bottom: 10px; width: 70%; margin-right: auto;margin-left: auto;">
                <div class="card">
                    <div class="card-header seleccion" id="headingOne" >
                        + DETALLES
                    </div>
            ...
            <!-- DETALLES -->
            <!--<div  style="border-bottom: dashed 1px black;padding-bottom: 15px; height: 350px; overflow: auto;">
                
                <h1 style="text-align:center;color:#999999;margin-top:20px;font-weight:normal;font-size:18px;">DETALLES</h1>
        ...
        <!--<input type="submit"  value="GUARDAR" name="btnEnviar" class="login-button" style="display: block;border-radius: 6px; margin: 0px; width: 63%; margin-left: auto; margin-right: auto; margin-bottom: 10px;">-->
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 150px;">
                ...
                <!--<div id="carouselExampleIndicators" class="carousel slide" data-ride="" style="height: 100%;">
                    ...
                    <div class="carousel-inner" style="height: 100%;">
                        <div class="carousel-item active" style="background-color: #1986C4; height: 100%;">
                            <label style="color: white">ODT <input id="txtODT" type="text" placeholder="ODT" class="form-control text-md" id="inputZip"></label>
                        </div>
                        <div class="carousel-item" style="background-color: #1986C4; height: 100%;">
                            <label style="color: white">Concepto <input class="form-control text-md" id="txtDescripcion" onkeyup="pegarTexto()" onblur ="prueba()" onmouseleave ="prueba()" placeholder="Concepto">
                            <label class="CellWithComment">
                                <span id="lblComentario" class="CellComment"></span>
                            </label></label>
                        </div>
                        <div class="carousel-item" style="background-color: #1986C4; height: 100%;">
                            <label style="color: white">Cantidad <input id="txtCantidad" onkeypress="return soloNumeros(event);" onkeyup="costear();" type="text" placeholder="Cantidad" class="form-control text-md" id="inputZip"></label>
                        </div>
                        <div class="carousel-item" style="background-color: #1986C4; height: 100%;">
                            <label style="color: white">Costo Unitario <input id="txtPrecio" onkeypress="return soloNumeros(event);" onkeyup="costear(); insertar0('txtPrecio')" type="text" placeholder="$0.00" class="form-control text-md" id="inputZip"></label>
                        </div>
...
<script type="text/javascript">
    ...
    $("#optCFDI option[value='22']").prop("selected",true);
    $("#optFPago option[value='22']").prop("selected",true);
    $("#optMPago option[value='3']").prop("selected",true);
    ...
    $("#optCFDI").on("change", function(){

        CFDI = $(this).val();
    });

    $("#optFPago").on("change", function(){

        fPago = $(this).val();
    });

    $("#optMPago").on("change", function(){
    ...
    $("#btnEnviar").click( function(){
        ...
        var orden        = $("#txtOCompra").val();
        var anticipo     = $("#txtAnticipo").val();
        var total        = $("#lblTotalT").html();
        total = total.split("$");

        if( CFDI == "" ){ showModError("Debe de seleccionar CFDI."); return false; }
        if( fPago == "" ){ showModError("Debe de seleccionar una forma de pago."); return false; }
        if( mPago == "" ){ showModError("Debe de seleccionar un método de pago."); return false; }
        if( anticipo !== "" ){

            anticipo = parseFloat(anticipo);
            if( isNaN(anticipo) ){

                showModError("Debe de ingresar solo numeros ");
                return false;
            }
        }else{
        ...
        datos.push({ name: "txtEvento" , value: evento });
        datos.push({ name: "txtOCompra" , value: orden });
        datos.push({ name: "txtAnticipo" , value: anticipo });
        datos.push({ name: "optCFDI" , value: CFDI });
        datos.push({ name: "optMPago" , value: mPago });
        datos.push({ name: "optFPago" , value: fPago });
        datos.push({ name: "arrFactura" , value: arrFactura_tmp });
        
        $.ajax({

            url: "<?= URL ?>ventas/uploadFacturas",
            method: "POST",
            data: datos,
            success: function( respuesta ){
                ...
                if( respuesta == true ){
                    ...
                    var time = setTimeout( function(){ window.location = "<?= URL?>ventas/solicitud_facturas" },2000);
                }else{

                    showModError("Hubo un error al insertar la factura.");
                }
            },
        });
    });
    ...
    $("#btnAgregar").click( function(){
        ...
        var detalle = '<tr class="detalle"><td style=" border-right: 1px #999 solid; "><p>' + odt +'</p></td><td style=" border-right: 1px #999 solid; "><p>' + esp + '</p></td><td style=" border-right: 1px #999 solid; "><p>' + cantidad + '</p></td><td style=" border-right: 1px #999 solid;"><p>' + "$" + precio + '</p></td><td class="eliminar" style=" border-right: 1px #999 solid; display: flex; align-items: center; justify-content: center"><img class="btnEliminar" src="<?= URL ?>public/img/tf.png" style="width: 25px; cursor: pointer" /></td><td style="display: none;"><p>' + subtotal + '</p></td><td style="display: none;"><p>' + iva + '</p></td><td><p>' + total + '</p></td></tr>';

        $("#tblDetalle").append(detalle);

        var totalT = sumaFactura(arrFactura);

        detalle = '<tr id="trTotal"><td></td><td></td><td></td><td></td><td></td><td style=" border-left: 1px #999 solid"><p id="lblTotalT">$' + totalT.toFixed(2) + '</p></td></tr>';
    ...
    $(document).on("click", ".btnEliminar", function() {
        ...
        $("#tblDetalle .detalle").each(function(row, tr){
            ...
            var esp      = $(tr).find('td:eq(1) p').html();
            var cantidad = parseInt($(tr).find('td:eq(2) p').html());
            var precio   = $(tr).find('td:eq(3) p').html();
            var subtotal = parseFloat($(tr).find('td:eq(5) p').html());
            var iva      = parseFloat($(tr).find('td:eq(6) p').html());
            var total    = $(tr).find('td:eq(7) p').html();
    ...
    function sumaFactura(arrFactura){
        ...
        for( var i=0; i < arrFactura.length; i++ ){
            ...
            totalT += parseFloat(arrFactura[i][6]['value']);
        }
