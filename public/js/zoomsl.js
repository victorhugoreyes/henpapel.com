...
(function ($, global) {
    ...
    $.extend(sergelandimagezoomer, {
        ...
        dsetting: { //default settings
             ...
             // descargar imágenes grandes
            loadinggif: '', // imagen mostrada al cargar imagen grande
            loadopacity: 0.1, // transparencia del fondo de la superposición
            loadbackground: '#878787', // color de fondo de la imagen tmb superpuesta al cargar imagen grande


            // lupa (cursorshade)
            cursorshade: true, //Mostrar contenedor de lupa
            magnifycursor: 'crosshair', // ver el cursor del mouse sobre tmb en formato css
            cursorshadecolor: '#fff', // color del contenedor de lupa CSS
            cursorshadeopacity: 0.3, // transparencia del envase de la lupa
            cursorshadeborder: '1px solid black', // borde externo de la lupa del contenedor CSS
            zindex: '', // contenedor de lupa de índice z
            stepzoom: 0.5, // Paso de zoom al desplazar la rueda del ratón					
            zoomrange: [3, 3], //rango de zoom
            zoomstart: 4, // 8, unidad de zoom inicial
            disablewheel: true, // Desactive el desplazamiento del documento con la rueda del mouse cuando el cursor está sobre la imagen tmb en caso de que el rango de zoom no esté configurado


            // insinuar(statusdiv)
            showstatus: true, // mostrar cuando se desplaza sobre el contenedor de ayuda tmb
            showstatustime: 2000, // contenedor de ayuda tiempo de visualización
            ...
            // fotos de contenedores grandes (magnifier)
            magnifierpos: 'right', // lado de visualización del contenedor  left/right
            magnifiersize: [0, 0], // tamaño del recipiente  
            magnifiereffectanimate: 'showIn', // efecto de ocultación / ocultación fadeIn/showIn/slideIn
            innerzoom: false, // mostrar contenedor dentro tmb
            innerzoommagnifier: false, // Mostrar contenedor como lupa
            descarea: false, // Mostrar contenedor en un área arbitraria, el área descarea debe tener width и height				
            leftoffset: 15, // margen izquierdo fotos tmb
            rightoffset: 15, // sangría a la derecha de imágenes tmb
            switchsides: true, // considerar el borde de la pantalla
            magnifierborder: '1px solid black', // bordillo exterio
            ...
            // factores de velocidad de animación
            scrollspeedanimate: 5 /*4*/ , // imágenes grandes de desplazamiento
            zoomspeedanimate: 7, // zoom (suavidad)
            loopspeedanimate: 2.5 /*2.45342*/ , //mover una lupa y un recipiente grande en un modo de lupa				
            magnifierspeedanimate: 350, // mostrar contenedor grande
